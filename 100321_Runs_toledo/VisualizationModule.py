...
def get_muni_centroids(MuniGeom,Selected_munis):
    
    ## Get the centroids of the selected municipalities
    

    MuniGeom_select = MuniGeom.loc[Selected_munis,:]
...
def plotSolution(MuniGeom_select,centroids_dict,BioParameters,Demand,MovementsKg):
